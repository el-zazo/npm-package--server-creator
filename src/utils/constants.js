...
const SERVER = {
  ...
  CORS: {
    DEFAULT_OPTIONS: {
      // To enable credentials, set a specific origin:
...
const MODEL = {
  DEFAULT_QUERY_OPTIONS: {
    sort: {},
    limit: 100, // Safe default — use no_pagination: true to bypass
    skip: 0,
    fields: null,
  },
  // Pagination defaults
...
const AUTH = {
  ...
  get SECRET_KEY() { return process.env.JWT_SECRET; },
  PASSTHROUGH: false,
...
const ROUTES = {
  ...
  ALWAYS_PROTECTED_ROUTES: ["getUserByToken"],
  METHODS: {
